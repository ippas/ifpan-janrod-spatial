...
out_path = f"{output_dir}/risperidone_half_SDMbench_CHAOS_PAS_original_logic.tsv"


# ============================================================
# Original SDMBench logic — technical patch only
# ============================================================
# Logic copied from SDMBench.py:
# - _compute_CHAOS()
# - fx_1NN()
# - fx_kNN()
# - _compute_PAS()
...
# - self=None is added because these functions are class methods in SDMBench.
# - logic inside the functions is unchanged.


def _compute_CHAOS(self=None, clusterlabel=None, location=None):
...
def fx_1NN(self=None, i=None, location_in=None):
...
def fx_kNN(self=None, i=None, location_in=None, k=None, cluster_in=None):
...
def _compute_PAS(self=None, clusterlabel=None, location=None):
    ...
    results = [fx_kNN(i=i, location_in=matched_location, k=10, cluster_in=clusterlabel) for i in range(matched_location.shape[0])]
...
# ============================================================
# SDMBench compute_CHAOS() calls _compute_CHAOS(...)
# SDMBench compute_PAS() calls _compute_PAS(...)
# We inject the original-logic functions into the globals
# visible to those SDMBench functions.
...
# ============================================================
# Create AnnData and compute SDMBench metrics
# ============================================================
...
# Spatial tissue coordinates, not UMAP/PCA.
