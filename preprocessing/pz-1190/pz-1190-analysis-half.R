...
path_to_data <- "data/pz-1190/spaceranger-corrected-half//"
nfeatures <- 2000
dims <- 1:30
...
sample_names <- c(samples_saline, samples_pz1190)
...
summarize_and_test(spatial_data = pz1190_st_data_half,
                   ...
                   mean_threshold = 0,
                   metrics = c("mean", "median", "skewness", "kurtosis")) -> pz1190_summary_statistics_half


save(samples_saline,
     samples_pz1190,
     pz1190_integrate_half,
     pz1190_st_data_half,
     pz1190_summary_statistics_half, 
     file = "results/risperidone/pz1190-half.RData")
