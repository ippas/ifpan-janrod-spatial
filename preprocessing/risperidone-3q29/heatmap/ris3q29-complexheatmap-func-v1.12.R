generate_cluster_heatmap <- function(data, genes, cluster_name, metadata,
  ...
  # 2) Filtracja clusteru i (opcjonalne) skalowanie ekspresji
  ...
  # 6) Przygotowanie Heatmap arguments z możliwością tytułu, zakresu skalowania i kolorów
  if (z_scale) {
  ...
  # 7) Wyświetlanie wartości w komórkach (opcjonalnie)
  if (show_values) {
  ...
  # 8) Dodanie adnotacji z kolorami grup
